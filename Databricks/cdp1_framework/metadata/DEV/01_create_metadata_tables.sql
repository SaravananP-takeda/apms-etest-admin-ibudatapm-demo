CREATE CATALOG IF NOT EXISTS dbx_uc_dedev;
CREATE SCHEMA IF NOT EXISTS dbx_uc_dedev.bdm_to_dbx_migration_meta;

CREATE TABLE IF NOT EXISTS dbx_uc_dedev.bdm_to_dbx_migration_meta.dc_entity_mstr (
...
CREATE TABLE IF NOT EXISTS dbx_uc_dedev.bdm_to_dbx_migration_meta.dc_load_strategy (
...
-- audit (audit_load.py)
CREATE TABLE IF NOT EXISTS dbx_uc_dedev.bdm_to_dbx_migration_meta.dc_excn_stat (
    excn_id STRING,
	app_id STRING,
	entity_id STRING,
    file_name STRING,
...
CREATE TABLE IF NOT EXISTS dbx_uc_dedev.bdm_to_dbx_migration_meta.dc_error_stat (
    excn_id STRING,
	app_id STRING NOT NULL,
	entity_id STRING NOT NULL,
