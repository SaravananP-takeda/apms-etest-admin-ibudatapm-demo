CREATE CATALOG IF NOT EXISTS deprd_dataengineering;
CREATE SCHEMA IF NOT EXISTS  deprd_dataengineering.eds_de_lake_cdp;

CREATE TABLE IF NOT EXISTS deprd_dataengineering.eds_de_lake_cdp.dc_entity_mstr (
...
CREATE TABLE IF NOT EXISTS deprd_dataengineering.eds_de_lake_cdp.dc_load_strategy (
...
-- audit (audit_load.py)
CREATE TABLE IF NOT EXISTS deprd_dataengineering.eds_de_lake_cdp.dc_excn_stat (
    excn_id STRING,
	app_id STRING,
	entity_id STRING,
    file_name STRING,
...
CREATE TABLE IF NOT EXISTS deprd_dataengineering.eds_de_lake_cdp.dc_error_stat (
    excn_id STRING,
	app_id STRING NOT NULL,
	entity_id STRING NOT NULL,
